    ...
    items: [
      {
        ...
        decision: "Van Heusen debe confirmar la convención exacta de nombres de archivo en el bucket S3 y validar la unicidad del prefijo Modelo+Color.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        owner: "Van Heusen (negocio)",
        context: "Bajo este alcance, el Proceso 3 busca la imagen en S3 usando únicamente el Modelo como prefijo — un prefijo más corto que bajo el alcance vigente, con mayor probabilidad teórica de colisión entre modelos distintos. Esto implica que Van Heusen debe reorganizar/cargar sus archivos de imagen agrupados por Modelo, no por Modelo+Color como hoy.",
        ...
        decision: "Van Heusen debe confirmar la convención exacta de nombres de archivo en el bucket S3 y validar la unicidad del prefijo de solo-Modelo, incluyendo la reorganización de archivos ya cargados bajo el esquema anterior.",
      },
      {
        num: "07",
        ...
        decision: "Van Heusen debe confirmar el nombre técnico de la UDT en su instalación de SAP y documentarlo para que el equipo de desarrollo lo use en la especificación del Proceso 2.",
      },
      {
        num: "08",
